...
export const metadata: Metadata = {
    ...
    applicationName: 'طلامی',
    openGraph: {
        siteName: 'طلامی',
        title: 'طلامی | بهترین های بازار ارز دیجیتال و بورس در یک نگاه',
        description:
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            disambiguatingDescription:
                                'سامانه هوشمند طلامی پیام‌های تمام کانال‌های بورسی تلگرام را جمع‌آوری می‌کند و با استفاده از هوش مصنوعی سیگنال‌های خرید و فروش هر کانال شناسایی و بازدهی سبد سهامی معرفی شده توسط هر کانال را محاسبه می‌کند',
