...
import { useSignals } from '@/app/[lang]/(user)/top-assets/services/useSignals';
...
import { DataTable } from '@/app/[lang]/(user)/top-assets/components/data-table';
...
export function Content({ dict, lang }) {
    ...
    const displaySignals = signals.sort(
        (a, b) => b.signals_count.buy_count - a.signals_count.buy_count
    );
    const columns = [
        {
            accessorKey: 'symbol',
            ...
            <div className="mb-5 border border-gray-100 bg-white p-5 text-neutral-800 md:rounded-lg">
                ...
                <div className="flex w-full flex-col justify-center gap-2.5 md:flex-row md:items-center">
                    ...
                    <RadioGroup
                        ...
                        className="flex w-full max-w-xl items-center gap-3 rounded-md border border-neutral-100 px-1.5 py-1.5"
                        onValueChange={(val) =>
                            setFilters((prevState) => ({
                                ...prevState,
                                ...(val === '1' || val === '2'
                                    ? { type: 'all', group_id: val }
                                    : { type: val, group_id: null }),
                            }))
                        }
                    >
