                ...
                <Card className="col-span-3">
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            <Link href={`/${lang}/admin/orders`} className="block w-full text-left px-4 py-3 rounded-lg border hover:bg-gray-50 transition-colors">
                            ...
                            <Link href={`/${lang}/admin/users-kyc`} className="block w-full text-left px-4 py-3 rounded-lg border hover:bg-gray-50 transition-colors">
                            ...
                            <Link href={`/${lang}/admin/audit-logs`} className="block w-full text-left px-4 py-3 rounded-lg border hover:bg-gray-50 transition-colors">
