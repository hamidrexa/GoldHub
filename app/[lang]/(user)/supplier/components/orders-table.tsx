                    ...
                    <div className="w-full overflow-x-auto max-w-[calc(100vw-3rem)]">
                        <Table className="min-w-[700px]">
                            <TableHeader>
                                <TableRow>
                                    <TableHead
                                        className="sticky left-0 z-20 bg-card shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">{dict.marketplace.supplier.ordersPage.table.orderId}</TableHead>
                                    ...
                                    <TableHead
                                        className="text-right">{dict.marketplace.supplier.ordersPage.table.actions}</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {filteredHistory.map((order) => (
                                    <TableRow key={order.id}>
                                        ...
                                        <TableCell>{order.items.length} {dict.marketplace.supplier.ordersPage.itemsSuffix}</TableCell>
