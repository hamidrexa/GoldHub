...
export default function SupplierOrdersClient({ dict }: SupplierOrdersClientProps) {
            ...
            <Tabs value={statusFilter} onValueChange={(value) => setStatusFilter(value as StatusFilter)}>
                <TabsList>
                    <TabsTrigger value="all">
                        {dict.marketplace.supplier.ordersPage.tabs.all} ({statusCounts.all})
                    </TabsTrigger>
                    <TabsTrigger value="pending_supplier">
                        {dict.marketplace.supplier.ordersPage.tabs.new} ({statusCounts.pending_supplier})
                    </TabsTrigger>
                    <TabsTrigger value="confirmed">
                        {dict.marketplace.supplier.ordersPage.tabs.processing} ({statusCounts.confirmed})
                    </TabsTrigger>
                    <TabsTrigger value="shipped">
                        {dict.marketplace.supplier.ordersPage.tabs.shipped} ({statusCounts.shipped})
                    </TabsTrigger>
                    <TabsTrigger value="closed">
                        {dict.marketplace.supplier.ordersPage.tabs.closed} ({statusCounts.closed})
                    </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value={statusFilter} className="mt-6">
                    <Card>
                        <CardHeader>
                            <CardTitle>
                                {statusFilter === 'all' ? dict.marketplace.supplier.ordersPage.cardTitles.all :
                                    statusFilter === 'pending_supplier' ? dict.marketplace.supplier.ordersPage.cardTitles.new :
                                        statusFilter === 'confirmed' ? dict.marketplace.supplier.ordersPage.cardTitles.processing :
                                            statusFilter === 'shipped' ? dict.marketplace.supplier.ordersPage.cardTitles.shipped :
                                                dict.marketplace.supplier.ordersPage.cardTitles.closed}
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
